function [DVs,x, its,pen_scal,N,classMeans, gamma]=PenZDA(train,D,penalty,tol,maxits,beta,quiet, consttype,gamscale)
...
%     tic
    ...
    elseif isequal(consttype,'sphere')
        ...
        [x,DVs(:,i),~,its]=SZVD_ADMM_S(R,N,RN, D,sols0,s,gamma(i),beta,tol,maxits,quiet);
